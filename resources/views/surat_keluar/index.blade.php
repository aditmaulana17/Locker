                    ...
                    <div id="kategoriDropdownMenu" class="filter-dropdown-menu">
                        <div class="filter-dropdown-menu-header">
                            ...
                            <div class="filter-dropdown-actions">
                                ...
                                <button type="button" id="clearAllKategori" class="filter-dropdown-action clear">Batalkan</button>
                            </div>
                        </div>
                            ...
                            <div class="filter-dropdown-options">
                                @foreach($kategoris as $kategori)
                                    <label class="filter-dropdown-option">
                                        ...
                                        <span title="{{ $kategori->nama_kategori }}">{{ $kategori->nama_kategori }}</span>
                                    </label>
                                @endforeach
                            </div>
                        @else
                            <div class="filter-dropdown-empty">Belum ada kategori surat.</div>
                        @endif
                    ...
                    <div id="statusDropdownMenu" class="filter-dropdown-menu">
                        <div class="filter-dropdown-menu-header">
                            ...
                            <div class="filter-dropdown-actions">
                                ...
                                <span class="filter-dropdown-divider">|</span>
                                <button type="button" id="clearAllStatus" class="filter-dropdown-action clear">Batalkan</button>
                            </div>
                        </div>
