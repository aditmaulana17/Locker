                ...
                <section class="mt-5">
                    <div class="section-heading">
                        ...
                        <div>
                            ...
                            <p class="section-description">
                                Upload dokumen surat yang akan disimpan sebagai arsip digital.
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="archive-card-header">
                            <div>
                                ...
                                <p class="archive-card-description">
                                    Pilih file surat yang ingin diarsipkan.
                                </p>
                            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    fileInput.addEventListener('change', function () {
        ...
        if (file.size > MAX_FILE_SIZE) {
            ...
            fileLabelText.textContent = 'Ukuran file melebihi 15 MB';
        ...
        fileInfo.textContent = `Ukuran: ${sizeInMb} MB`;
        fileInfo.classList.remove('hidden');
    });
