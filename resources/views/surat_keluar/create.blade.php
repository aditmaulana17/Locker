    ...
    <div class="mb-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div class="min-w-0">
            ...
            <p class="mt-0.5 text-sm text-slate-500">
                Isi formulir untuk menambahkan arsip surat keluar baru.
            </p>
        </div>
            ...
            <div class="p-4 sm:p-5">
                ...
                <section>
                    <div class="section-heading">
                        ...
                        <div>
                            ...
                            <p class="section-description">Lengkapi identitas dan informasi utama surat keluar.</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-x-4 gap-y-3 md:grid-cols-2">
                        ...
                        <div class="form-group">
                            ...
                            >
                            <p class="form-hint">
                                Gunakan field ini untuk mencatat instansi, lembaga, atau pihak tujuan surat.
                            </p>
                            @error('pengirim')
                                <p class="form-error-text">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            >
                            <p class="form-hint">Tanggal surat keluar atau tanggal surat dikirim.</p>
                        ...
                        <div class="form-group">
                            ...
                            >
                                <option value="" disabled @selected(!old('kategori_surat_id'))>
                        ...
                        <div class="form-group">
                            ...
                            >
                                ...
                                <option value="dikirim" @selected(old('status') === 'dikirim')>Dikirim</option>
                                <option value="diarsipkan" @selected(old('status') === 'diarsipkan')>Diarsipkan</option>
                            </select>
                            @error('status')
                                <p class="form-error-text">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="form-group md:col-span-2">
                            ...
                            <p class="form-hint">
                                Ringkasan bersifat opsional dan membantu pencarian atau identifikasi isi surat.
                            </p>
                            @error('ringkasan')
                                <p class="form-error-text">{{ $message }}</p>
                            @enderror
                ...
                <section class="mt-5">
                    <div class="section-heading">
                        ...
                        <div>
                            <h2 class="section-title">Lampiran Berkas Digital</h2>
                    ...
                    <div class="archive-card">
                        <div class="archive-card-header">
                            <div>
                                <h3 class="archive-card-title">Dokumen Surat</h3>
                                <p class="archive-card-description">File dapat berupa PDF, JPG, JPEG, atau PNG.</p>
                            </div>
                        ...
                        <div id="upload-section">
                            ...
                            <p class="mt-1.5 text-[11px] leading-relaxed text-slate-400">
                                File disimpan sebagai lampiran surat keluar. Tidak tersedia fitur scan atau kamera pada surat keluar.
                            </p>
                        </div>
                    </div>
                </section>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function resetFileInput() {
        ...
        if (fileLabelText) {
            fileLabelText.textContent = 'Klik untuk memilih file';
    ...
    form?.addEventListener('submit', function (event) {
        ...
        if (suratDate && keluarDate && keluarDate < suratDate) {
            ...
            if (typeof window.Swal !== 'undefined') {
                ...
                window.alert('Tanggal keluar tidak boleh lebih awal dari tanggal surat.');
            }
        ...
        if (fileInput && fileInput.files && fileInput.files.length > 0) {
            ...
            if (file.size > MAX_FILE_SIZE) {
                ...
                if (typeof window.Swal !== 'undefined') {
                    ...
                    window.alert('Ukuran lampiran maksimal 10 MB.');
                }
