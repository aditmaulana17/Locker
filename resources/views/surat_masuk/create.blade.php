                ...
                <section class="mt-5">
                    ...
                    <div class="section-heading">
                        ...
                        <div>
                            ...
                            <p class="section-description">
                                Lengkapi dokumen digital dan lokasi penyimpanan fisik.
                            </p>
                        </div>
...
<script>
    ...
    async function startCamera() {
        ...
        try {
            ...
            alert(
                'Gagal mengakses kamera. Pastikan izin kamera telah diberikan pada browser.'
            );
        }
    }
    ...
    if (formSurat) {
        ...
        formSurat.addEventListener(
            ...
            function (event) {
                ...
                /*
                 * Validasi:
                 * Berkas digital wajib berupa
                 * file upload ATAU hasil scan kamera.
                 */
                if (
                    ...
                    alert(
                        'Berkas digital wajib diisi. Silakan upload file atau scan menggunakan kamera.'
                    );
