...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 pb-12">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <a href="{{ route('surat-masuk.index') }}" class="inline-flex items-center justify-center px-4 py-2 text-xs font-semibold text-slate-600 bg-white border border-slate-300 rounded-xl shadow-xs hover:bg-slate-50 hover:text-slate-800 focus:outline-none transition w-full sm:w-auto">
    ...
    <form method="POST" action="{{ route('surat-masuk.store') }}" enctype="multipart/form-data" id="form-surat">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50/50 border-b border-blue-100/80 px-6 py-4 flex items-center justify-between">
                <div class="flex items-center text-blue-900 text-sm">
                    ...
                    <span class="flex flex-col sm:flex-row sm:items-center gap-1">
                        ...
                        <strong class="font-bold text-blue-700 font-mono bg-white px-3 py-1 rounded-lg text-xs border border-blue-200 shadow-2xs w-fit">{{ $nomorAgenda }}</strong>
                    </span>
                </div>
            </div>
                ...
                <div class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="nomor_surat" value="{{ old('nomor_surat') }}" required placeholder="Contoh: 005/B/I/2026"
                        ...
                        <div>
                            ...
                            <input type="text" name="pengirim" value="{{ old('pengirim') }}" required placeholder="Masukkan nama pengirim surat..."
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_terima" value="{{ old('tanggal_terima', date('Y-m-d')) }}" required
                                class="w-full rounded-xl border border-slate-200 bg-slate-50/50 px-3.5 py-2.5 text-sm text-slate-700 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition duration-150 font-medium @error('tanggal_terima') !border-rose-500 !bg-rose-50/30 @enderror">
            ...
            <div class="flex flex-col-reverse sm:flex-row items-center justify-end gap-3 px-6 sm:px-8 py-4 bg-slate-50/80 border-t border-slate-100">
                <a href="{{ route('surat-masuk.index') }}" class="w-full sm:w-auto px-5 py-2.5 text-xs font-semibold text-slate-600 bg-white border border-slate-300 rounded-xl hover:bg-slate-100 hover:text-slate-800 transition shadow-xs text-center">
                    Batal
                </a>
