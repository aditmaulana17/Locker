                                ...
                                <div class="mb-2.5 flex items-start gap-1.5 rounded-md border border-blue-200 bg-blue-50 px-2.5 py-2">
                                    ...
                                    <div class="text-[9px] leading-relaxed">
                                        ...
                                        <p class="text-blue-600">
                                            PDF tetap PDF. JPG/JPEG/PNG dikompres menjadi JPG sebelum disimpan.
                                        </p>
                                    </div>
                                </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function buildCameraImage() {
        ...
        if (
            ...
            if (!smallerContext) {
                throw new Error(
                    'Canvas resize browser tidak tersedia.'
                );
            }
    ...
    function handleFileChange() {
        ...
        if (
            ...
            compressionStatus.textContent =
                '✓ Gambar akan diproses di server dan dikompres menjadi JPG sebelum disimpan ke Supabase.';
        } else {
            compressionStatus.textContent =
                '✓ PDF akan dikirim ke server sementara lalu disimpan ke Supabase tanpa konversi gambar.';
        }
