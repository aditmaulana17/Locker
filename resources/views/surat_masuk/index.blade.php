...
(function () {
    ...
    function loadScript(src) {
        return new Promise(function (resolve, reject) {
            ...
            if (existingScript) {
                ...
                if (src.includes('moment') && window.moment) {
                    resolve();
                    return;
                }
    ...
    async function initializePageAssets() {
        try {
            ...
            console.error(
                'Gagal memuat komponen halaman Surat Masuk:',
                error
            );
    ...
    /* =========================================================
       FULL PAGE
    ========================================================= */
    function initializeSuratMasukPage() {
        initializeBasicFeatures();
        initializeDateRange();
    }
    ...
    function initializeKategoriFilter() {
        ...
        const selectAllButton = document.getElementById('selectAllKategori');
        const clearAllButton = document.getElementById('clearAllKategori');
    ...
    function initializeStatusFilter() {
        ...
        const selectAllButton = document.getElementById('selectAllStatus');
        const clearAllButton = document.getElementById('clearAllStatus');
    ...
    function initializeDeleteConfirmation() {
        ...
        buttons.forEach(function (button) {
            if (button.dataset.deleteInitialized === '1') {
                return;
            }
