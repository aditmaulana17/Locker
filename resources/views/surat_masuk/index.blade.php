            ...
            <div class="grid grid-cols-1 gap-2 lg:grid-cols-12">
                <div class="lg:col-span-5">
                    <div class="relative">
                        ...
                        <input type="text" id="search" name="search" value="{{ request('search') }}" placeholder="Cari perihal atau nomor surat..." autocomplete="off" class="archive-filter-input h-11 w-full rounded-xl pl-9 pr-3 text-xs text-slate-700 outline-none transition placeholder:text-slate-400 sm:text-sm">
                    </div>
                </div>
                ...
                <div class="lg:col-span-4">
                    <div class="date-range-wrapper">
                        <div class="relative">
                            ...
                            <input type="text" id="date-range" value="{{ $visibleDateRange }}" readonly autocomplete="off" placeholder="Pilih rentang tanggal..." class="archive-filter-input date-range-input h-11 w-full rounded-xl pl-9 pr-10 text-xs font-medium text-slate-700 outline-none transition placeholder:text-slate-400 sm:text-sm">
                ...
                <tbody>
                    @forelse($suratMasuks ?? [] as $surat)
                        ...
                        <tr>
                            ...
                            <td class="cell-subject max-w-xs truncate" title="{{ $surat->perihal ?? '-' }}">{{ $surat->perihal ?? '-' }}</td>
                            <td class="cell-category">{{ $surat->kategori?->nama_kategori ?? '-' }}</td>
                                ...
                                <div class="action-buttons">
                                    ...
                                    @if($canManage)
                                        <a href="{{ route('surat-masuk.edit', $surat) }}" class="action-button edit" title="Ubah Data" aria-label="Ubah data surat">
                                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.5 2.5a2.121 2.121 0 013 3L11.828 15H9v-2.828L18.5 2.5z"/></svg>
                                        </a>
                                        ...
                                        <form action="{{ route('surat-masuk.destroy', $surat) }}" method="POST" class="delete-form inline">
                                            ...
                                            <button type="button" class="action-button delete delete-btn" title="Hapus Surat" aria-label="Hapus surat">
                                                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 11v6m4-6v6"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7h16m-5-3H9a1 1 0 00-1 1v2h8V5a1 1 0 00-1-1z"/></svg>
                                            </button>
                                        </form>
                                    @endif
                                </div>
                        ...
                        <tr>
                            <td colspan="6" class="archive-table-empty">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    @if($hasFilters)
                                        <a href="{{ route('surat-masuk.index') }}" class="mt-3 inline-flex items-center rounded-lg bg-slate-900 px-3 py-2 text-[11px] font-semibold text-white transition hover:bg-slate-800">Reset Filter</a>
                                    @elseif($canManage)
...
(function(){
    ...
    function showMonthPanel(calendarDate,anchor,side){
        ...
        MONTHS.forEach((monthName,monthIndex)=>{
            ...
            if(monthIndex===calendarDate.getMonth())button.classList.add('active');
