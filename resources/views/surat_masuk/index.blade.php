...
.custom-date-picker{position:fixed;z-index:999999;width:720px;max-width:calc(100vw - 20px);overflow:hidden;border-radius:18px;font-family:inherit}
.custom-date-picker.hidden,.custom-picker-panel.hidden,.archive-filter-menu.hidden{display:none}
.custom-date-picker-header{display:flex;align-items:center;justify-content:space-between;padding:13px 15px;border-bottom:1px solid #cbd5e1}
...
.custom-date-picker-close{width:32px;height:32px;border-radius:9px;font-size:19px}
.custom-date-picker-close:hover,.custom-picker-panel-close:hover{background:#f1f5f9;color:#ef4444}
.custom-date-picker-calendars{display:grid;grid-template-columns:repeat(2,minmax(0,1fr))}
.custom-calendar{padding:15px 17px 13px}
.custom-calendar+.custom-calendar{border-left:1px solid #cbd5e1}
.custom-calendar-head{display:flex;align-items:center;justify-content:space-between;gap:6px;min-height:40px;margin-bottom:7px}
.custom-calendar-month-buttons{display:flex;align-items:center;justify-content:center;flex:1;gap:4px}
...
.custom-calendar-month,.custom-calendar-year{position:relative;display:inline-flex;align-items:center;justify-content:center;gap:5px;min-height:34px;border:0;border-radius:9px;padding:7px 10px;background:#f8fafc;color:#334155;font-family:inherit;font-size:12px;font-weight:800;cursor:pointer}
.custom-calendar-month:hover,.custom-calendar-year:hover{background:#eff6ff;color:#2563eb}
.custom-calendar-month::after,.custom-calendar-year::after{content:'';width:6px;height:6px;margin-top:-3px;border-right:1.5px solid currentColor;border-bottom:1.5px solid currentColor;transform:rotate(45deg)}
.custom-calendar-weekdays,.custom-calendar-days{display:grid;grid-template-columns:repeat(7,minmax(0,1fr));gap:3px}
.custom-calendar-weekdays{margin-bottom:4px}
.custom-calendar-weekday{display:flex;align-items:center;justify-content:center;height:28px;color:#94a3b8;font-size:10px;font-weight:800}
...
.custom-date-picker-button{height:36px;border:1px solid #cbd5e1;border-radius:9px;background:#f8fafc;color:#475569;padding:0 14px;font-family:inherit;font-size:11px;font-weight:700;cursor:pointer}
...
.custom-picker-panel-header{display:flex;align-items:center;justify-content:space-between;gap:8px;margin-bottom:12px;padding-bottom:10px;border-bottom:1px solid #cbd5e1}
.custom-picker-panel-title{flex:1;color:#334155;font-size:13px;font-weight:800;text-align:center}
.custom-picker-panel-close{width:30px;height:30px;border-radius:8px;font-size:18px}
.custom-picker-month-grid,.custom-picker-year-grid{display:grid;gap:8px}
.custom-picker-month-grid{grid-template-columns:repeat(3,1fr)}
.custom-picker-year-grid{grid-template-columns:repeat(4,1fr)}
.custom-picker-option{display:flex;align-items:center;justify-content:center;min-height:42px;border:1px solid #cbd5e1;border-radius:10px;background:#fff;color:#475569;font-family:inherit;font-size:11px;font-weight:700;cursor:pointer}
...
.custom-picker-option.current{box-shadow:inset 0 0 0 1px #93c5fd}
.custom-picker-option.active.current{box-shadow:none}
.custom-picker-year-navigation{display:flex;align-items:center;gap:5px}
.custom-picker-year-nav{display:inline-flex;align-items:center;justify-content:center;width:30px;height:30px;border:0;border-radius:8px;background:#f8fafc;color:#64748b;cursor:pointer}
.custom-picker-year-nav:hover{background:#eff6ff;color:#2563eb}

.archive-filter-dropdown{position:relative;min-width:0}
.archive-filter-trigger{display:flex;align-items:center;width:100%;min-height:56px;gap:12px;padding:10px 14px;border:1px solid #cbd5e1;border-radius:14px;background:#fff;color:#334155;text-align:left;cursor:pointer;transition:border-color .15s ease,background .15s ease,box-shadow .15s ease}
.archive-filter-trigger:hover{border-color:#94a3b8;background:#f8fafc}
.archive-filter-trigger.is-open,.archive-filter-trigger:focus{outline:none;border-color:#93c5fd;background:#f8fbff;box-shadow:0 0 0 3px rgba(59,130,246,.1)}
.archive-filter-trigger.is-active{border-color:#93c5fd;background:#f8fbff}
.archive-filter-icon{display:inline-flex;align-items:center;justify-content:center;width:36px;height:36px;flex:0 0 36px;border-radius:10px}
.archive-filter-icon.category{background:#eff6ff;color:#2563eb}
.archive-filter-icon.status{background:#fffbeb;color:#d97706}
.archive-filter-trigger-content{min-width:0;flex:1}
.archive-filter-trigger-title{display:block;color:#334155;font-size:13px;font-weight:700;line-height:1.25}
.archive-filter-trigger-subtitle{display:block;margin-top:3px;overflow:hidden;color:#94a3b8;font-size:10px;line-height:1.3;text-overflow:ellipsis;white-space:nowrap}
.archive-filter-count{display:inline-flex;align-items:center;justify-content:center;min-width:72px;min-height:24px;flex:0 0 auto;padding:0 9px;border-radius:999px;font-size:10px;font-weight:700;white-space:nowrap}
.archive-filter-count.category{border:1px solid #bfdbfe;background:#eff6ff;color:#2563eb}
...
.archive-filter-menu-description{display:block;margin-top:3px;color:#94a3b8;font-size:10px}
.archive-filter-menu-actions{display:flex;align-items:center;gap:5px;flex:0 0 auto}
.archive-filter-action{border:0;border-radius:7px;padding:6px 8px;background:transparent;font-size:10px;font-weight:700;cursor:pointer}
.archive-filter-action.select{color:#2563eb}
.archive-filter-action.select:hover{background:#eff6ff}
.archive-filter-action.clear{color:#64748b}
.archive-filter-action.clear:hover{background:#f1f5f9}
.archive-filter-options{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;max-height:280px;overflow-y:auto;padding:12px}
.archive-filter-options::-webkit-scrollbar{width:6px}
.archive-filter-options::-webkit-scrollbar-track{background:#f8fafc}
.archive-filter-options::-webkit-scrollbar-thumb{border-radius:999px;background:#cbd5e1}
.archive-filter-option{display:flex;align-items:center;min-width:0;min-height:44px;gap:9px;padding:8px 10px;border:1px solid #cbd5e1;border-radius:10px;background:#fff;cursor:pointer;transition:border-color .15s ease,background .15s ease}
.archive-filter-option:hover,.archive-filter-option.is-selected{border-color:#93c5fd;background:#eff6ff}
.archive-filter-option input{width:16px;height:16px;flex:0 0 16px;margin:0;accent-color:#2563eb;cursor:pointer}
.archive-filter-option-text{min-width:0;overflow:hidden;color:#475569;font-size:11px;font-weight:600;text-overflow:ellipsis;white-space:nowrap}
.archive-filter-option.is-selected .archive-filter-option-text{color:#1d4ed8}
.archive-filter-menu-footer{display:flex;align-items:center;justify-content:space-between;gap:10px;padding:10px 14px;border-top:1px solid #cbd5e1}
.archive-filter-footer-count,.archive-filter-footer-hint{font-size:10px}
.archive-filter-footer-count{color:#94a3b8;font-weight:600}
...
(function(){
    ...
    if(dateInput && picker){
        ...
        closePickerButton?.addEventListener('click',function(e){
            e.preventDefault();
            e.stopPropagation();
            hidePicker();
        });

        clearPickerButton?.addEventListener('click',function(e){
            e.preventDefault();
            e.stopPropagation();
            clearDateRange();
        });

        applyPickerButton?.addEventListener('click',function(e){
            e.preventDefault();
            e.stopPropagation();
            applyDateRange();
        });
    ...
    function initializeFilterDropdowns(){
        ...
        dropdowns.forEach(dropdown=>{
            ...
            checkboxes.forEach(checkbox=>{
                checkbox.addEventListener('change',()=>updateDropdown(dropdown));
            });
