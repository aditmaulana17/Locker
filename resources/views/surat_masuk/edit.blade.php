...
@endphp
<style>
.edit-surat-page{max-width:1240px;margin:0 auto;padding:0 2px 20px;color:#334155}
.edit-surat-page .edit-header{margin-bottom:16px}
.edit-surat-page .main-card{overflow:hidden;border:1.5px solid #64748b;border-radius:18px;background:#fff;box-shadow:0 2px 6px rgba(15,23,42,.06),0 12px 28px rgba(15,23,42,.05)}
.edit-surat-page .section-body{padding:20px}.edit-surat-page .section-body>*+*{margin-top:20px!important}
.edit-surat-page .section-title{margin-bottom:14px}
.edit-surat-page .field-grid{gap:14px}
.edit-surat-page input:not([type=file]),.edit-surat-page select,.edit-surat-page textarea{border-color:#cbd5e1;border-radius:11px;min-height:42px}
.edit-surat-page input:not([type=file]),.edit-surat-page select{padding-top:.65rem;padding-bottom:.65rem}
.edit-surat-page textarea{min-height:104px}
.edit-surat-page label{font-size:13px}
.edit-surat-page .agenda-bar{padding:13px 18px;border-bottom:1.5px solid #94a3b8;background:#f8fafc}
.edit-surat-page .agenda-bar .text-base{font-size:15px}
.edit-surat-page .digital-card,.edit-surat-page .physical-card{display:flex;min-height:100%;flex-direction:column;padding:15px!important;border:1.5px solid #64748b!important;border-radius:16px!important;background:#f8fafc!important;box-shadow:0 1px 3px rgba(15,23,42,.05),0 6px 16px rgba(15,23,42,.03)}
.edit-surat-page .attachment-grid{align-items:stretch;gap:18px}
.edit-surat-page .digital-inner,.edit-surat-page .physical-inner,.edit-surat-page .physical-card>.rounded-2xl{border:1px solid #cbd5e1!important;border-radius:13px!important;background:#fff}
.edit-surat-page .physical-card>.digital-inner{height:100%}
.edit-surat-page .mode-button{min-height:66px;border-radius:11px!important}
.edit-surat-page #upload-box{min-height:165px;padding:24px 16px;border-width:2px}
.edit-surat-page #scan-panel>div{border-color:#94a3b8}
.edit-surat-page #scan-panel .relative.aspect-video{min-height:240px}
.edit-surat-page #selected-file,.edit-surat-page #scan-result{border-width:1px}
.edit-surat-page .info-box{border:1px solid #cbd5e1!important;border-radius:11px!important}
.edit-surat-page .footer-bar{border-top:1.5px solid #94a3b8;background:#f8fafc;padding:13px 18px}
.edit-surat-page .footer-bar a,.edit-surat-page .footer-bar button{min-height:42px;border-radius:11px}
.edit-surat-page .btn-main{min-height:42px;border-radius:11px}
.edit-surat-page .error-box{border-width:1px;border-radius:13px}
@media(max-width:767px){
.edit-surat-page{padding:0 0 16px}
.edit-surat-page .section-body{padding:15px}
.edit-surat-page .agenda-bar{padding:12px 14px}
.edit-surat-page .field-grid{gap:12px}
.edit-surat-page .attachment-grid{gap:12px}
.edit-surat-page #scan-panel .relative.aspect-video{min-height:200px}
.edit-surat-page #upload-box{min-height:145px;padding:20px 12px}
.edit-surat-page .footer-bar{padding:11px 14px}
}
</style>
    ...
    */
    async function compressImageElement(
        ...
        */
        ...
        |----------------------------------------------------------------------
        | Prioritas 2:
        | Jika 2.5 MB tidak tercapai,
        | gunakan hasil terkecil <= 5 MB.
        |----------------------------------------------------------------------
        */
        if (
            smallestResult &&
    ...
    form.addEventListener(
        ...
        event => {
            ...
            */
            ...
            /*
            |----------------------------------------------------------------------
            | PASTIKAN FILE TIDAK MELEBIHI BATAS
            |----------------------------------------------------------------------
            */
            const selected =
                fileInput.files?.[0];
