...
.edit-surat-page .section-body > section + section {
    margin-top: 22px;
}
...
.edit-surat-page input:not([type="file"]):focus,
.edit-surat-page select:focus,
.edit-surat-page textarea:focus {
    border-color: #4f46e5;
...
.edit-surat-page .section-divider {
    padding-top: 21px;
...
.edit-surat-page .attachment-card {
    display: flex;
...
.edit-surat-page .attachment-card-header {
    min-height: 42px;
    margin-bottom: 12px;
}
...
.edit-surat-page .mode-button.active {
    border-color: #4f46e5;
    background: #eef2ff;
}

.edit-surat-page .mode-button:not(.active) {
    background: #ffffff;
}
...
.edit-surat-page #upload-box:hover {
    border-color: #6366f1;
    background: #eef2ff;
}
...
.edit-surat-page .physical-description {
    max-width: 540px;
}
...
<div class="edit-header">
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="flex min-w-0 items-center gap-3">
            ...
            <div class="header-icon flex shrink-0 items-center justify-center">
                <svg
                    class="h-5 w-5"
                    fill="none"
                    stroke="currentColor"
        ...
        <a
            ...
            class="inline-flex w-fit shrink-0 items-center gap-2 rounded-lg border border-slate-300 bg-white px-3.5 py-2 text-sm font-semibold text-slate-600 shadow-sm transition hover:bg-slate-50 hover:text-slate-800"
        >
            <svg
                class="h-4 w-4"
                fill="none"
...
@if($errors->any())
    <div class="mb-4 rounded-xl border border-red-200 bg-red-50 p-3.5 error-box">
        ...
        <div class="flex items-start gap-3">
            ...
            <div class="min-w-0">
                ...
                <ul class="mt-1.5 space-y-0.5 text-xs text-red-700">
    ...
    <div class="main-card">
        ...
        <div class="agenda-bar">
            ...
            <div class="flex flex-col gap-2.5 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex min-w-0 items-center gap-2.5">
                    ...
                    <div class="agenda-icon flex shrink-0 items-center justify-center">
                        <svg
                            class="h-4 w-4"
                            fill="none"
                            stroke="currentColor"
                ...
                <span class="w-fit rounded-full border border-slate-300 bg-white px-2.5 py-1 text-[10px] font-semibold text-slate-600">
        ...
        <div class="section-body">
            ...
            <section>
                ...
                <div class="section-title flex items-start gap-2.5">
                ...
                <div class="grid grid-cols-1 gap-3.5 md:grid-cols-2 field-grid">
                    ...
                    <div>
                        <label
                            for="nomor_surat"
                            class="mb-1.5 block font-semibold text-slate-700"
                        >
                            Nomor Surat
                        ...
                        <input
                            ...
                            class="@error('nomor_surat') border-red-400 @enderror"
                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="@error('pengirim') border-red-400 @enderror"
                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            required
                            value="{{ $tanggalSurat }}"
                            class="@error('tanggal_surat') border-red-400 @enderror"
                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            required
                            value="{{ $tanggalTerima }}"
                            class="@error('tanggal_terima') border-red-400 @enderror"
                        >
                    ...
                    <div>
                        ...
                        <select
                            ...
                            required
                            class="@error('kategori_surat_id') border-red-400 @enderror"
                        >
                            <option
                                value=""
                                disabled
                    ...
                    <div>
                        ...
                        <select
                            ...
                            name="status"
                            required
                            class="@error('status') border-red-400 @enderror"
                        >
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea
                            ...
                            class="@error('perihal') border-red-400 @enderror"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea
                            ...
                            class="@error('ringkasan') border-red-400 @enderror"
            ...
            <section class="section-divider">
                ...
                <div class="section-title flex items-start gap-2.5">
                    ...
                    <div>
                        ...
                        <p class="mt-0.5 text-xs text-slate-500">
                            Ganti dokumen atau perbarui lokasi arsip fisik.
                        </p>
                    </div>
                ...
                <div class="attachment-grid">
                    ...
                    <div class="attachment-card">
                        ...
                        <div class="attachment-card-header flex items-start justify-between gap-3">
                            ...
                            <span class="shrink-0 rounded-full border border-slate-300 bg-white px-2 py-0.5 text-[10px] font-semibold text-slate-600">
                                Opsional
                            </span>
                        ...
                        <div class="mb-3 rounded-lg border border-blue-200 bg-blue-50 p-2.5">
                        ...
                        <div class="mb-3 grid grid-cols-2 gap-2">
                            ...
                            <button
                                ...
                                id="mode-upload-btn"
                                aria-selected="true"
                                class="mode-button active flex items-center gap-2 px-2.5 py-2 text-left transition"
                            >
                            ...
                            <button
                                ...
                                id="mode-scan-btn"
                                aria-selected="false"
                                class="mode-button flex items-center gap-2 px-2.5 py-2 text-left transition"
                            >
                            ...
                            <div class="flex items-center gap-2.5">
                                ...
                                @if($suratMasuk->lampiran_file)
                                    ...
                                    <a
                                        ...
                                        class="shrink-0 rounded-lg bg-slate-100 px-2.5 py-1.5 text-[10px] font-semibold text-slate-700 transition hover:bg-indigo-100 hover:text-indigo-700"
                                    >
                                        Lihat
                                    </a>
                        ...
                        <div id="upload-panel">
                            ...
                            <label
                                for="lampiran_file"
                                id="upload-box"
                                class="group flex cursor-pointer flex-col items-center justify-center text-center transition"
                            >
                                <span class="mb-2 flex h-10 w-10 items-center justify-center rounded-lg bg-indigo-100 text-indigo-600">
                                    <svg
                                        class="h-5 w-5"
                                        fill="none"
                                        stroke="currentColor"
                            ...
                            <div
                                id="selected-file"
                                class="mt-2.5 hidden rounded-lg border border-emerald-200 bg-emerald-50 p-2.5"
                            >
                                <div class="flex items-center gap-2.5">
                                    ...
                                    <button
                                        type="button"
                                        id="clear-file-btn"
                                        class="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg text-slate-400 transition hover:bg-red-100 hover:text-red-600"
                                        title="Hapus file"
                        ...
                        >
                            ...
                            <div class="overflow-hidden bg-white">
                                ...
                                <div class="flex flex-col gap-2 border-b border-slate-300 bg-slate-50 p-3 sm:flex-row sm:items-center sm:justify-between">
                                    ...
                                    <span class="w-fit rounded-full bg-indigo-100 px-2 py-0.5 text-[9px] font-semibold text-indigo-700">
                                        Kamera
                                    </span>
                                ...
                                <div class="relative aspect-video overflow-hidden bg-slate-950">
                                    ...
                                    >
                                        <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-white/10 text-slate-400">
                                            <svg
                                                class="h-6 w-6"
                                                fill="none"
                                                stroke="currentColor"
                                    ...
                                    <div
                                        id="camera-error"
                                        class="absolute bottom-2 left-2 right-2 hidden rounded-lg border border-red-400/30 bg-red-950/90 p-2.5 text-[10px] font-medium text-red-200"
                                        role="alert"
                                    ></div>

                                    <div class="pointer-events-none absolute inset-6 rounded-lg border-2 border-dashed border-white/40 sm:inset-8"></div>

                                </div>

                                {{-- CAMERA ACTIONS --}}

                                <div class="grid grid-cols-1 gap-1.5 p-3 sm:grid-cols-3">

                                    <button
                                        type="button"
                                        id="start-camera-btn"
                                        class="inline-flex items-center justify-center gap-1.5 rounded-lg bg-indigo-600 px-3 py-2 text-xs font-semibold text-white transition hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-50"
                                    >
                                        Aktifkan Kamera
                                    </button>
                                    ...
                                    <button
                                        ...
                                        id="stop-camera-btn"
                                        disabled
                                        class="inline-flex items-center justify-center gap-1.5 rounded-lg border border-slate-300 bg-white px-3 py-2 text-xs font-semibold text-slate-700 transition hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-50"
                                    >
                                        Matikan Kamera
                                    </button>
                                ...
                                <div
                                    id="scan-result"
                                    class="hidden border-t border-slate-300 bg-emerald-50 p-3"
                                >
                                    <div class="flex items-start justify-between gap-3">
                                        ...
                                        <button
                                            type="button"
                                            id="retake-btn"
                                            class="shrink-0 rounded-lg border border-emerald-300 bg-white px-2.5 py-1.5 text-[10px] font-semibold text-emerald-700 transition hover:bg-emerald-100"
                                        >
                                            Scan Ulang
                                        </button>
                                    ...
                                    <div class="mt-2.5 overflow-hidden rounded-lg border border-emerald-200 bg-white">
                                        <img
                                    ...
                                    <div
                                        ...
                                        class="mt-1.5 text-center text-[10px] font-semibold text-emerald-700"
                                    ></div>
                        ...
                        <div class="info-box mt-2.5 bg-slate-50 p-2.5">
                    ...
                    <div class="attachment-card">
                        ...
                        <div class="physical-inner inner-card">
                            ...
                            <h4 class="mt-3 text-sm font-bold text-slate-800">
                                Lokasi Penyimpanan
                            </h4>

                            <p class="physical-description mt-1 text-xs leading-relaxed text-slate-500">
                                Masukkan posisi rak, lemari, box, atau map
                                tempat arsip fisik disimpan.
                            </p>
                            ...
                            <div class="mt-4">
                                ...
                                <input
                                    ...
                                    class="@error('lokasi_arsip_fisik') border-red-400 @enderror"
                                >
        ...
        <div class="footer-bar">
            ...
            <a
                href="{{ route('surat-masuk.index') }}"
                class="inline-flex items-center justify-center border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100"
            >
                Batal
            </a>
            ...
            <button
                type="submit"
                id="submit-btn"
                class="inline-flex items-center justify-center bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-70"
            >
                <svg
