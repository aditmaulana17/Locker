            ...
            >
                ...
                >
                    <path
                        ...
                        stroke-width="1.8"
                        d="M5 19a2 2 0 01-2-2V7a2 2 0 012-2h4l2 2h9a2 2 0 012 2v1M5 19h14a2 2 0 002-2v-5a2 2 0 00-2-2H9a2 2 0 00-2 2v5a2 2 0 01-2 2z"
                    />
                </svg>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    */
    ...
    const openButton =
        document.getElementById('mobile-sidebar-open');
    ...
    */
    ...
    setTimeout(() => {
        ...
        document
            .getElementById('flash-success')
            ?.remove();

        document
            .getElementById('flash-error')
            ?.remove();
    ...
    document.addEventListener(
        ...
        event => {
            ...
            Swal.fire({
                ...
                text:
                    'Data yang dihapus akan dipindahkan ke arsip sampah.',
                ...
                customClass: {
                    ...
                    confirmButton:
                        'ml-2 rounded-xl bg-red-500 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-red-600',

                    cancelButton:
                        'rounded-xl bg-slate-200 px-4 py-2.5 text-sm font-semibold text-slate-700 shadow-sm hover:bg-slate-300'
