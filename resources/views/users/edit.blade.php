...
$currentIsActive = (bool) ($user->is_active ?? true);
            ...
            <section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-3">
                    ...
                    <div class="form-group">
                        ...
                        <p class="form-help">
                            Role Staf disimpan sebagai
                            <strong class="font-semibold text-slate-500">
                                staff
                            </strong>
                            di database.
                        </p>
                    ...
                    <div class="form-group">
                        ...
                        <select
                            ...
                            id="is_active"
                            required
                            class="form-control-custom @error('is_active') form-error @enderror"
                        >

                            <option
                                value="1"
                                {{ (string) $oldIsActive === '1' ? 'selected' : '' }}
                            >
                                Aktif (Dapat Login)
                            </option>
                        ...
                        <p class="form-help">
                            Akun nonaktif tidak dapat masuk ke dalam sistem.
                        </p>
