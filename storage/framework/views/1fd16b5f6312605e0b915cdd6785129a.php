...
<div class="min-h-screen bg-slate-50">
    ...
    <aside id="app-sidebar" class="fixed inset-y-0 left-0 z-40 flex w-64 -translate-x-full flex-col border-r border-slate-800 bg-slate-900 text-slate-300 shadow-2xl transition-transform duration-300 lg:translate-x-0">
        ...
        <div class="flex h-20 shrink-0 items-center justify-between border-b border-slate-800/80 px-5">
            <a href="<?php echo e(route('dashboard')); ?>" class="flex min-w-0 items-center gap-3">
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-5">
            <div class="space-y-1.5">
                ...
                <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center gap-3 rounded-xl px-3.5 py-2.5 text-sm font-medium transition-all <?php echo e(request()->routeIs('dashboard') ? 'bg-blue-600 font-semibold text-white shadow-lg shadow-blue-600/30' : 'text-slate-400 hover:bg-slate-800/70 hover:text-white'); ?>">
                ...
                <a href="<?php echo e(route('surat-masuk.index')); ?>" class="flex items-center gap-3 rounded-xl px-3.5 py-2.5 text-sm font-medium transition-all <?php echo e(request()->routeIs('surat-masuk.*') ? 'bg-blue-600 font-semibold text-white shadow-lg shadow-blue-600/30' : 'text-slate-400 hover:bg-slate-800/70 hover:text-white'); ?>">
                    <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('surat-keluar.index')); ?>" class="flex items-center gap-3 rounded-xl px-3.5 py-2.5 text-sm font-medium transition-all <?php echo e(request()->routeIs('surat-keluar.*') ? 'bg-blue-600 font-semibold text-white shadow-lg shadow-blue-600/30' : 'text-slate-400 hover:bg-slate-800/70 hover:text-white'); ?>">
                    <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('disposisi.index')); ?>" class="flex items-center gap-3 rounded-xl px-3.5 py-2.5 text-sm font-medium transition-all <?php echo e(request()->routeIs('disposisi.*') ? 'bg-blue-600 font-semibold text-white shadow-lg shadow-blue-600/30' : 'text-slate-400 hover:bg-slate-800/70 hover:text-white'); ?>">
                    <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <?php if($isAdmin): ?>
                ...
                <a href="<?php echo e(route('kategori.index')); ?>" class="flex items-center gap-3 rounded-xl px-3.5 py-2.5 text-sm font-medium transition-all <?php echo e(request()->routeIs('kategori.*') ? 'bg-blue-600 font-semibold text-white shadow-lg shadow-blue-600/30' : 'text-slate-400 hover:bg-slate-800/70 hover:text-white'); ?>">
                    <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('users.index')); ?>" class="mt-1.5 flex items-center gap-3 rounded-xl px-3.5 py-2.5 text-sm font-medium transition-all <?php echo e(request()->routeIs('users.*') ? 'bg-blue-600 font-semibold text-white shadow-lg shadow-blue-600/30' : 'text-slate-400 hover:bg-slate-800/70 hover:text-white'); ?>">
                    <svg class="h-5 w-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="shrink-0 border-t border-slate-800/80 px-4 py-4 text-center">
            <p class="text-[11px] font-medium text-slate-500">E-Arsip &copy; <?php echo e(date('Y')); ?></p>
        </div>
    </aside>
        ...
        <header class="sticky top-0 z-20 border-b border-slate-200 bg-white/90 shadow-sm backdrop-blur-md">
            <div class="flex min-h-[68px] items-center justify-between gap-3 px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex min-w-0 items-center gap-2.5 sm:gap-3">
                    ...
                    <div class="min-w-0">
                        <h1 class="truncate text-base font-bold tracking-tight text-slate-800 sm:text-lg"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></h1>
                ...
                <div class="flex shrink-0 items-center gap-2 sm:gap-4">
                    ...
                    <div class="flex items-center gap-2 sm:gap-3 sm:border-l sm:border-slate-200 sm:pl-4">
                        ...
                        <div class="hidden min-w-0 sm:block">
                            <p class="max-w-[160px] truncate text-sm font-bold leading-tight text-slate-800"><?php echo e($authUser->name ?? 'Pengguna'); ?></p>
                            <p class="mt-0.5 max-w-[180px] truncate text-[11px] font-medium text-slate-400">
                                <?php echo e(ucfirst($userRole)); ?>

                                <?php if(!empty($authUser->jabatan)): ?>
                                    &middot; <?php echo e($authUser->jabatan); ?>
            ...
            <?php if(session('success')): ?>
                <div id="flash-success" class="fixed right-4 top-4 z-[60] flex w-[calc(100%-2rem)] max-w-sm items-start gap-3 rounded-2xl border border-emerald-100 bg-white p-4 shadow-xl">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <p class="mt-0.5 text-xs font-medium leading-relaxed text-slate-600"><?php echo e(session('success')); ?></p>
                    </div>
            ...
            <?php if(session('error')): ?>
                <div id="flash-error" class="fixed right-4 top-4 z-[60] flex w-[calc(100%-2rem)] max-w-sm items-start gap-3 rounded-2xl border border-red-100 bg-white p-4 shadow-xl">
                    ...
                    <div class="min-w-0 flex-1">
                        ...
                        <p class="mt-0.5 text-xs font-medium leading-relaxed text-slate-600"><?php echo e(session('error')); ?></p>
                    </div>
...
</html><?php /**PATH D:\E-Arsip\resources\views/layouts/app.blade.php ENDPATH**/ ?>