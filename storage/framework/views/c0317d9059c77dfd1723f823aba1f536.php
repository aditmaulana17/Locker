    ...
    <div class="min-h-screen flex flex-col lg:flex-row text-slate-800">
        ...
        <div class="w-full lg:w-1/2 xl:w-5/12 bg-white flex flex-col justify-center px-6 sm:px-8 lg:px-12 xl:px-16 py-8 sm:py-12 min-h-screen lg:min-h-0 overflow-y-auto">
            ...
            <div class="w-full max-w-md mx-auto space-y-6">
                ...
                <!-- Form Login -->
                <form id="loginForm" method="POST" action="<?php echo e(route('login.attempt')); ?>" class="space-y-4">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" id="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus placeholder="admin@admin.com"
