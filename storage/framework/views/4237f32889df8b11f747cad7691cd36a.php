...
<div class="space-y-4 sm:space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-slate-200/80 p-3 sm:p-4">
        <form method="GET" action="<?php echo e(route('kategori.index')); ?>" class="flex flex-col sm:flex-row items-center gap-2.5 sm:gap-3">
            ...
            <div class="flex items-center gap-2 w-full sm:w-auto">
                ...
                <?php if(request()->filled('search')): ?>
                    <a href="<?php echo e(route('kategori.index')); ?>" class="px-3.5 py-2 bg-slate-100 text-slate-600 rounded-lg text-xs sm:text-sm font-medium hover:bg-slate-200 transition-colors border border-slate-200 text-center">
                        Reset
                    </a>
                <?php endif; ?>
            </div>
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50/80 transition-colors">
                        ...
                        <td class="px-3.5 sm:px-5 py-3 sm:py-4">
                            ...
                            <?php if($k->keterangan): ?>
                                <div class="text-[11px] sm:text-xs text-slate-400 truncate max-w-xs mt-0.5" title="<?php echo e($k->keterangan); ?>"><?php echo e($k->keterangan); ?></div>
                            <?php endif; ?>
                        </td>
                        ...
                        <td class="px-3.5 sm:px-5 py-3 sm:py-4 whitespace-nowrap">
                            ...
                            ?>
                            <span class="text-[11px] sm:text-xs font-semibold px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-full border <?php echo e($sifatClass); ?>">
                        ...
                        <td class="px-3.5 sm:px-5 py-3 sm:py-4 text-right whitespace-nowrap">
                            <div class="inline-flex items-center justify-end gap-1">
                                ...
                                <form action="<?php echo e(route('kategori.destroy', $k)); ?>" method="POST" class="inline delete-form">
                                    <?php echo csrf_field(); ?> 
...
<div id="modalEdit<?php echo e($k->id); ?>" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm p-3 sm:p-4 overflow-y-auto">
        ...
        <form method="POST" action="<?php echo e(route('kategori.update', $k)); ?>">
            ...
            <div class="p-4 sm:p-6 space-y-3.5 sm:space-y-4">
                <div>
                    ...
                    <input type="text" name="nama_kategori" value="<?php echo e($k->nama_kategori); ?>" required class="w-full px-3 sm:px-3.5 py-2 sm:py-2.5 rounded-xl border border-slate-300 text-xs sm:text-sm text-slate-800 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all">
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-4">
                    <div>
                        ...
                        <input type="text" name="kode" value="<?php echo e($k->kode); ?>" required class="w-full px-3 sm:px-3.5 py-2 sm:py-2.5 rounded-xl border border-slate-300 text-xs sm:text-sm font-mono text-slate-800 uppercase focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all">
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <textarea name="keterangan" rows="3" class="w-full px-3 sm:px-3.5 py-2 sm:py-2.5 rounded-xl border border-slate-300 text-xs sm:text-sm text-slate-800 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all resize-none"><?php echo e($k->keterangan); ?></textarea>
                </div>
            </div>
            ...
            <div class="flex flex-col-reverse sm:flex-row items-center justify-end gap-2 px-4 sm:px-6 py-3.5 sm:py-4 border-t border-slate-100 bg-slate-50/50">
                <button type="button" onclick="document.getElementById('modalEdit<?php echo e($k->id); ?>').classList.add('hidden')" class="w-full sm:w-auto px-4 py-2 sm:py-2.5 text-xs sm:text-sm font-medium text-slate-600 hover:text-slate-800 hover:bg-slate-100 rounded-xl transition-colors text-center">Batal</button>
