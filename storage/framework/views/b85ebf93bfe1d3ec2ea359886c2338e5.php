...
<div class="max-w-7xl mx-auto space-y-6 px-4 sm:px-6 lg:px-8 py-6">
    ...
    <?php if(session('success')): ?>
        <div class="flex items-center justify-between p-4 bg-emerald-50 border border-emerald-200 text-emerald-800 rounded-2xl shadow-sm transition duration-200">
            <div class="flex items-center gap-3">
                ...
                <span class="text-xs sm:text-sm font-semibold"><?php echo e(session('success')); ?></span>
            </div>
    ...
    <?php if(session('error')): ?>
        <div class="flex items-center justify-between p-4 bg-rose-50 border border-rose-200 text-rose-800 rounded-2xl shadow-sm transition duration-200">
            <div class="flex items-center gap-3">
                ...
                <span class="text-xs sm:text-sm font-semibold"><?php echo e(session('error')); ?></span>
            </div>
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gradient-to-r from-slate-900 via-slate-800 to-indigo-950 p-6 sm:p-7 rounded-3xl border border-slate-800 shadow-md text-white">
        <div class="flex items-center gap-4">
            <a href="<?php echo e(route('surat-masuk.index')); ?>" class="w-10 h-10 rounded-2xl bg-white/10 hover:bg-white/20 text-white flex items-center justify-center transition shrink-0 backdrop-blur-sm" title="Kembali ke Daftar Surat">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/></svg>
            </a>
            <div>
                <nav class="flex items-center gap-2 text-xs text-slate-300 font-medium mb-1">
                    <a href="<?php echo e(route('surat-masuk.index')); ?>" class="hover:text-white transition">Surat Masuk</a>
                    <span>/</span>
        ...
        <div class="flex flex-wrap items-center gap-2.5 pt-3 md:pt-0 border-t md:border-t-0 border-white/10">
            <?php if(Route::has('surat-masuk.edit')): ?>
                <a href="<?php echo e(route('surat-masuk.edit', $suratMasuk)); ?>" class="inline-flex items-center justify-center gap-2 px-4 py-2.5 text-xs font-semibold bg-amber-500/20 text-amber-300 hover:bg-amber-500/30 rounded-2xl transition border border-amber-500/30 backdrop-blur-sm shadow-sm">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                    <span>Edit Surat</span>
                </a>
            <?php endif; ?>

            <?php if(Route::has('surat-masuk.cetak-disposisi')): ?>
                <a href="<?php echo e(route('surat-masuk.cetak-disposisi', $suratMasuk)); ?>" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center gap-2 px-4 py-2.5 text-xs font-semibold bg-emerald-500/20 text-emerald-300 hover:bg-emerald-500/30 rounded-2xl transition border border-emerald-500/30 backdrop-blur-sm shadow-sm">
            ...
            <?php if(Route::has('surat-masuk.cetak-label')): ?>
                <a href="<?php echo e(route('surat-masuk.cetak-label', $suratMasuk)); ?>" target="_blank" rel="noopener noreferrer" class="inline-flex items-center justify-center gap-2 px-4 py-2.5 text-xs font-semibold bg-blue-500/20 text-blue-300 hover:bg-blue-500/30 rounded-2xl transition border border-blue-500/30 backdrop-blur-sm shadow-sm">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <div class="lg:col-span-2 bg-gradient-to-b from-white via-slate-50/50 to-slate-100/60 rounded-3xl shadow-md border border-slate-200 p-6 sm:p-8 space-y-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-start justify-between pb-6 border-b-2 border-slate-200 gap-4">
                <div class="space-y-2">
                    ...
                    <h2 class="text-xl sm:text-2xl font-black text-slate-900 leading-snug break-words">
                        <?php echo e($suratMasuk->perihal ?? 'Tanpa Perihal'); ?>
                    ...
                    <div class="flex flex-wrap items-center gap-2.5 pt-1">
                        <span class="inline-flex items-center px-3 py-1 rounded-xl text-xs font-mono font-bold bg-indigo-100 text-indigo-800 border border-indigo-300 shadow-2xs">
                            #<?php echo e($suratMasuk->nomor_agenda ?? $suratMasuk->id); ?>

                        </span>
                        <span class="text-slate-400">&bull;</span>
                        <span class="text-xs text-slate-600">No. Surat: <strong class="text-slate-900 font-semibold break-all"><?php echo e($suratMasuk->nomor_surat ?? '-'); ?></strong></span>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="p-5 bg-white rounded-2xl border-2 border-slate-200 space-y-1.5 shadow-sm">
                    ...
                    <p class="text-sm font-bold text-slate-900 break-words">
                        <?php echo e($suratMasuk->pengirim ?? $suratMasuk->instansi?->nama_instansi ?? '-'); ?>
                ...
                <div class="p-5 bg-white rounded-2xl border-2 border-slate-200 space-y-1.5 shadow-sm">
                    ...
                    <p class="text-sm font-bold text-slate-900 break-words">
                        <?php echo e($suratMasuk->kategori?->nama_kategori ?? $suratMasuk->kategori ?? '-'); ?>
                ...
                <div class="p-5 bg-white rounded-2xl border-2 border-slate-200 space-y-1.5 shadow-sm">
                    ...
                    <p class="text-sm font-bold text-slate-900">
                        <?php echo e($suratMasuk->tanggal_surat ? \Carbon\Carbon::parse($suratMasuk->tanggal_surat)->translatedFormat('d F Y') : '-'); ?>
                ...
                <div class="p-5 bg-white rounded-2xl border-2 border-slate-200 space-y-1.5 shadow-sm">
                    ...
                    <p class="text-sm font-bold text-slate-900">
                        <?php echo e($suratMasuk->tanggal_terima ? \Carbon\Carbon::parse($suratMasuk->tanggal_terima)->translatedFormat('d F Y') : '-'); ?>
                ...
                <div class="p-5 bg-white rounded-2xl border-2 border-slate-200 space-y-1.5 shadow-sm">
                    ...
                    <p class="text-sm font-bold text-slate-900 truncate">
                        <?php echo e($suratMasuk->penerima?->name ?? $suratMasuk->penerima ?? '-'); ?>
            ...
            <?php if(!empty($suratMasuk->ringkasan) || !empty($suratMasuk->isi_surat)): ?>
                <div class="pt-2">
                    <div class="p-5 bg-white rounded-2xl border-2 border-slate-200 space-y-2 shadow-sm">
                        ...
                        <div class="text-sm text-slate-800 font-medium leading-relaxed whitespace-pre-line break-words">
                            <?php echo e($suratMasuk->ringkasan ?? $suratMasuk->isi_surat); ?>
                    ...
                    <div class="space-y-4">
                        <div class="flex flex-wrap items-center justify-between gap-3 bg-white p-3.5 rounded-2xl border-2 border-slate-200 shadow-2xs">
                            <div class="flex flex-wrap items-center gap-2.5 w-full sm:w-auto">
                                <a href="<?php echo e($resolvedUrl); ?>" target="_blank" rel="noopener noreferrer" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-xs font-bold bg-indigo-600 text-white hover:bg-indigo-700 transition shadow-sm shadow-indigo-600/20">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/></svg>
                                    <span>Buka Berkas</span>
                                </a>
                                <a href="<?php echo e($resolvedUrl); ?>" download class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-xs font-semibold bg-white text-slate-700 hover:bg-slate-100 transition border-2 border-slate-200 shadow-2xs">
                        ...
                        <div class="bg-slate-900/10 p-3 rounded-2xl border-2 border-slate-300 overflow-hidden backdrop-blur-sm">
                            <?php if(in_array($extension, ['jpg', 'jpeg', 'png', 'webp', 'gif'])): ?>
                                <div class="text-center overflow-hidden rounded-xl bg-white p-2">
                                    <img src="<?php echo e($resolvedUrl); ?>" alt="Lampiran Surat Masuk" class="max-h-[500px] mx-auto object-contain rounded-xl shadow-xs">
                                </div>
                            <?php elseif($extension === 'pdf'): ?>
                                <iframe src="<?php echo e($resolvedUrl); ?>" class="w-full h-[500px] border-0 rounded-xl bg-white shadow-sm" title="Pratinjau PDF"></iframe>
                            <?php else: ?>
                                <div class="text-center py-10 bg-white rounded-xl border border-slate-200">
                                    ...
                                    <p class="text-xs text-slate-600 font-medium">Pratinjau tidak tersedia untuk format <code class="bg-slate-100 px-1 py-0.5 rounded text-slate-800">.<?php echo e($extension ?: 'berkas'); ?></code></p>
        ...
        <div class="bg-gradient-to-b from-white via-slate-50/50 to-slate-100/60 rounded-3xl shadow-md border border-slate-200 p-5 sm:p-6 flex flex-col justify-between space-y-5">
            <div>
                <div class="flex items-center justify-between pb-4 border-b-2 border-slate-200">
                    ...
                    <?php if(Route::has('disposisi.create')): ?>
                        <a href="<?php echo e(route('disposisi.create', $suratMasuk)); ?>" class="inline-flex items-center px-3.5 py-2 text-xs font-bold text-purple-700 bg-purple-100 hover:bg-purple-200 border border-purple-300 rounded-xl transition shadow-2xs">
                    ...
                    <?php elseif(Route::has('surat-masuk.disposisi.store')): ?>
                        ...
                        <div class="relative pl-6 space-y-2 group">
                            ...
                            <div class="flex items-center justify-between gap-2">
                                <div class="text-xs font-bold text-slate-900 flex items-center gap-1.5 flex-wrap">
                                    <span class="truncate max-w-[110px]" title="<?php echo e($d->dari?->name ?? 'Admin'); ?>"><?php echo e($d->dari?->name ?? 'Admin'); ?></span>
                                    ...
                                    <span class="text-purple-700 truncate max-w-[110px]" title="<?php echo e($d->kepada?->name ?? $d->tujuan ?? '-'); ?>"><?php echo e($d->kepada?->name ?? $d->tujuan ?? '-'); ?></span>
                                </div>
                                ...
                                ?>
                                <span class="px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider rounded-lg border shadow-2xs shrink-0 <?php echo e($statusClass); ?>">
                            ...
                            <div class="p-3.5 bg-white border-2 border-slate-200 rounded-2xl text-xs text-slate-700 leading-relaxed shadow-2xs break-words font-medium">
                                <?php echo e($d->instruksi ?? $d->catatan ?? '-'); ?>

                            </div>

                            <div class="text-[10px] text-slate-500 font-semibold pt-0.5">
                                <?php echo e($d->created_at ? \Carbon\Carbon::parse($d->created_at)->translatedFormat('d/m/Y H:i') : '-'); ?>
...
<?php if(Route::has('surat-masuk.disposisi.store')): ?>
<div id="modal-disposisi" class="hidden fixed inset-0 z-50 overflow-y-auto bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4 transition-all">
    <div class="bg-white rounded-3xl max-w-md w-full p-6 shadow-xl border border-slate-200 space-y-4 relative" onclick="event.stopPropagation()">
        ...
        <form id="form-disposisi" action="<?php echo e(route('surat-masuk.disposisi.store', $suratMasuk)); ?>" method="POST" class="space-y-4">
            <?php echo csrf_field(); ?>
            <div>
