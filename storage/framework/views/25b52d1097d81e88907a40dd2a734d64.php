<?php $__env->startSection('title', 'Edit Surat Masuk'); ?>
...
<div class="w-full max-w-5xl mx-auto space-y-6 pb-12">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-slate-100 shadow-xs">
        ...
        <div>
            <a href="<?php echo e(route('surat-masuk.index')); ?>" class="inline-flex items-center justify-center px-4 py-2.5 text-xs font-semibold text-slate-600 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 hover:text-slate-800 transition shadow-xs">
    ...
    <!-- Form Utama -->
    <form method="POST" action="<?php echo e(route('surat-masuk.update', $suratMasuk->id)); ?>" enctype="multipart/form-data" class="space-y-6">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>

        <input type="hidden" name="nomor_agenda" value="<?php echo e(old('nomor_agenda', $suratMasuk->nomor_agenda)); ?>">
        ...
        <div class="bg-white rounded-2xl shadow-xs border border-slate-100 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-50/80 via-indigo-50/40 to-transparent border-b border-slate-100 px-6 sm:px-8 py-4 flex items-center justify-between">
                <div class="flex items-center text-slate-700 text-xs sm:text-sm font-medium">
                    ...
                    <span>Nomor Agenda Sistem: <strong class="font-bold text-blue-700 font-mono bg-white px-3 py-1 rounded-lg ml-1.5 text-xs border border-blue-200/80 shadow-2xs"><?php echo e($suratMasuk->nomor_agenda); ?></strong></span>
                </div>
            </div>
                ...
                <div class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" name="nomor_surat" value="<?php echo e(old('nomor_surat', $suratMasuk->nomor_surat)); ?>" required placeholder="Contoh: 005/B/I/2026"
                                class="w-full rounded-xl border border-slate-200 bg-slate-50/30 px-4 py-3 text-sm text-slate-700 placeholder-slate-400 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition duration-150 <?php $__errorArgs = ['nomor_surat'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="pengirim" value="<?php echo e(old('pengirim', isset($suratMasuk) ? $suratMasuk->pengirim : '')); ?>" required placeholder="Ketik nama instansi pengirim..."
                                class="w-full rounded-xl border border-slate-200 bg-slate-50/30 px-4 py-3 text-sm text-slate-700 placeholder-slate-400 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition duration-150 <?php $__errorArgs = ['pengirim'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> !border-rose-500 !bg-rose-50/30 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_surat" value="<?php echo e(old('tanggal_surat', $suratMasuk->tanggal_surat)); ?>" required
                                class="w-full rounded-xl border border-slate-200 bg-slate-50/30 px-4 py-3 text-sm text-slate-700 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition duration-150 font-medium <?php $__errorArgs = ['tanggal_surat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> !border-rose-500 !bg-rose-50/30 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_terima" value="<?php echo e(old('tanggal_terima', $suratMasuk->tanggal_terima)); ?>" required
                                class="w-full rounded-xl border border-slate-200 bg-slate-50/30 px-4 py-3 text-sm text-slate-700 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition duration-150 font-medium <?php $__errorArgs = ['tanggal_terima'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> !border-rose-500 !bg-rose-50/30 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="kategori_surat_id" required class="w-full rounded-xl border border-slate-200 bg-slate-50/30 px-4 py-3 text-sm text-slate-700 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition duration-150 font-medium <?php $__errorArgs = ['kategori_surat_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> !border-rose-500 !bg-rose-50/30 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php $__currentLoopData = $kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($k->id); ?>" <?php echo e(old('kategori_surat_id', $suratMasuk->kategori_surat_id) == $k->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="status" required class="w-full rounded-xl border border-slate-200 bg-slate-50/30 px-4 py-3 text-sm text-slate-700 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition duration-150 font-medium <?php $__errorArgs = ['status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> !border-rose-500 !bg-rose-50/30 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                <option value="baru" <?php echo e(old('status', $suratMasuk->status) == 'baru' ? 'selected' : ''); ?>>Baru</option>
                                <option value="diproses" <?php echo e(old('status', $suratMasuk->status) == 'diproses' ? 'selected' : ''); ?>>Diproses</option>
                                <option value="didisposisikan" <?php echo e(old('status', $suratMasuk->status) == 'didisposisikan' ? 'selected' : ''); ?>>Didisposisikan</option>
                                <option value="selesai" <?php echo e(old('status', $suratMasuk->status) == 'selesai' ? 'selected' : ''); ?>>Selesai</option>
                                <option value="diarsipkan" <?php echo e(old('status', $suratMasuk->status) == 'diarsipkan' ? 'selected' : ''); ?>>Diarsipkan</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="perihal" rows="3" required placeholder="Tuliskan perihal atau isi ringkas surat secara jelas..."
                            class="w-full rounded-xl border border-slate-200 bg-slate-50/30 p-4 text-sm text-slate-700 placeholder-slate-400 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 outline-none transition duration-150 <?php $__errorArgs = ['perihal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> !border-rose-500 !bg-rose-50/30 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-center justify-end gap-3 px-6 sm:px-8 py-5 bg-slate-50/80 border-t border-slate-100">
                <a href="<?php echo e(route('surat-masuk.index')); ?>" class="px-5 py-2.5 text-xs font-semibold text-slate-600 bg-white border border-slate-200 rounded-xl hover:bg-slate-100 hover:text-slate-800 transition shadow-xs">
                    Batal
                </a>
